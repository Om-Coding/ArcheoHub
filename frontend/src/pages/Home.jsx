...
export default function Home() {
  return (
    <div className="animate-fade-in">
      <section className="text-center py-12" style={{ background: 'linear-gradient(120deg, rgba(20, 45, 79, 0.85), rgba(8, 18, 34, 0.95))', borderRadius:'24px', padding:'48px 20px', marginBottom:'24px' }}>
        <h1 className="text-4xl mb-4">Unearth the Past with <span className="text-gradient">ArchaeoHub</span></h1>
        <p className="text-muted text-xl mb-8 max-w-2xl mx-auto" style={{ maxWidth: '700px' }}>
        ...
        <div className="flex justify-center gap-4">
          <Link to="/artifacts" className="btn btn-primary pb-3"><Search size={18}/> Start Exploring</Link>
      ...
      <section className="diagram-panel">
        <h2 className="text-3xl mb-4">Adventure Diagram</h2>
        <p className="text-muted mb-6">A colorful pathway from artifact shop to the cave entrance, with treasure waiting at each checkpoint.</p>
        <div className="diagram-row">
          <article className="diagram-card">
            <div className="diagram-icon">🏪</div>
            <div className="diagram-label">Market Stall</div>
            <p>Buy, sell, and prepare your tools. This is where your quest begins.</p>
          </article>
          <article className="diagram-card">
            <div className="diagram-icon">🧭</div>
            <div className="diagram-label">Trail to Cave</div>
            <p>Follow the path through ancient geography, with artifacts along the way.</p>
          </article>
          <article className="diagram-card">
            <div className="diagram-icon">🕯️</div>
            <div className="diagram-label">Cave Entrance</div>
            <p>Enter the dig site and uncover hidden relics in a glowing cavern.</p>
          </article>
        </div>
      </section>
